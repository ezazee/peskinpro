...
@section('content')
    <section class="vs-hero-wrapper vs-hero-layout1 bg-light-theme">
        <div class="vs-hero-carousel" data-height="980" data-slidertype="responsive" data-allowfullscreen="false"
            ...
            "
                    ...
                    <a href="{{ route('shop.index') }}" class="vs-btn wave-style1">Belanja Sekarang<i
           ...
           "
                ...
                <img data-ls-mobile="left: 850px;"
                    src="{{ asset('asset-about/img/hero/Prebiotic-Feminine-Mousse-Cleanser-2.png') }}"
                    class="ls-layer ls-responsive" alt="Spa Girl"
                    style="
           top: 0;
           left: 50%;
           ...
           "
                ...
                <img data-ls-mobile="left: 850px;"
                    src="{{ asset('asset-about/img/hero/Prebiotic-Pore-ex-Facial-Pad2.png') }}"
                    class="ls-layer ls-responsive" alt="Spa Girl"
                    style="
           top: 0;
           left: 50%;
           ...
           "
                ...
                <img data-ls-mobile="left: 850px;"
                    src="{{ asset('asset-about/img/hero/Skin-Awakening-Glow-Serum-2.png') }}"
                    class="ls-layer ls-responsive" alt="Spa Girl"
                    style="
           top: 0;
           left: 50%;
           ...
           "
                ...
                <img data-ls-mobile="left: 850px;"
                    src="{{ asset('asset-about/img/hero/Vit-C-Tone-Up-Day-Cream-SPF502.png') }}"
                    class="ls-layer ls-responsive" alt="Spa Girl"
                    style="
           top: 0;
           left: 50%;
            ...
            <div class="row">
                    ...
                    <div class="about-image-box1 pt-100 pb-150 position-relative mb-30 mb-lg-0">
                        ...
                        <div class="small-img1 d-none d-xl-inline-block">
                            <a href="#"><img width="210"
                                    src="{{ asset('asset-about/img/about/lab1-02-scaled.jpg') }}"
                                    alt="About PE Skinpro" /></a>
                        </div>
                        <div class="small-img2 d-none d-xl-inline-block">
                            <a href="#"><img width="210"
                                    src="{{ asset('asset-about/img/about/lab2-02-scaled.jpg') }}"
                                    alt="About PE Skinpro" /></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    <div class="about-content-box1 pl-50">
                        ...
                        <div class="text-box1">
                            <p class="mb-0">
                                PE Skin Professional didirikan pada satu dekade yang lalu dengan tujuan untuk memproduksi
                                produk perawatan kecantikan pribadi yang terjangkau oleh semua orang. Perusahaan ini
                                diposisikan dengan departemen penjualan dan layanan yang kuat yang telah membangun fondasi
                                untuk pertumbuhan dan ekspansi berdasarkan perdagangan grosir berbagai macam produk
                                perawatan wajah, tubuh, rambut, tangan, dan kaki profesional. Kami menawarkan formulasi
                                perawatan kulit, rambut, dan tubuh yang dibuat dengan perhatian yang cermat terhadap detail
                                dan dengan khasiat yang kuat. Penelitian dan evaluasi dilakukan terhadap para pemasok
                                berdasarkan harga, kualitas, dukungan, ketersediaan, keandalan, kemampuan produksi dan
                                distribusi untuk memberikan produk dengan kualitas terbaik kepada para pelanggan.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="vs-service-wrapper vs-service-layout1 bg-light-theme space-top space-md-bottom" id="service">
        <div class="container">
            ...
            <div class="vs-btn-group text-center mt-5">
                <a href="{{ route('about.ListProducts') }}" class="vs-btn wave-style1 mb-3 mb-sm-0 mr-sm-3">Lihat Semua
                    Produk Kami<i class="far fa-arrow-right"></i></a>
            </div>
        </div>
    </section>
                    ...
                    <div class="about-content-box2 pr-xl-4 mb-30">
                        ...
                        <div class="text-box1 py-0 d-block d-md-flex align-items-center">
                            <div class="media-body">
                                <p class="mb-0">
                                    Untuk memastikan kualitas produk yang aman digunakan, kami menerapkan teknologi Jerman
                                    modern dalam pembuatan produk kami. PE Skin Professional telah membangun reputasi pada
                                    penggunaan komponen yang optimal dan berkualitas tinggi dalam produk dan lingkungan
                                    produksi untuk memastikan produk bermutu tinggi, mutakhir, dan dapat diandalkan yang
                                    setara dengan inovasi dan tren saat ini di pasar untuk memenuhi kebutuhan pelanggan.
                                    Produk kami bebas dari kekejaman, bersertifikat GMP, telah teruji di laboratorium, dan
                                    bebas dari THC.
                                </p>
                            </div>
                        </div>
    ...
    <div class="vs-brand-wrapper vs-brand-layout1 px-180">
        <div class="container-fluid">
            <div class="row vs-carousel text-center wow fadeInUp" data-wow-delay="0.3s" data-slidetoshow="5"
                ...
                <div class="col-xl-3">
                    <div class="vs-brand">
                        <img width="100" src="{{ asset('asset-about/img/cert/cruelty-cert.png') }}"
                            alt="Brand Image" />
                    </div>
                </div>
                <div class="col-xl-3">
                ...
                <div class="col-xl-3">
                    <div class="vs-brand">
                        <img width="100" src="{{ asset('asset-about/img/cert/halal-cert.png') }}"
                            alt="Brand Image" />
                    </div>
                </div>
                <div class="col-xl-3">
                    <div class="vs-brand">
                        <img width="100" src="{{ asset('asset-about/img/cert/lab-tested.png') }}"
                            alt="Brand Image" />
                    </div>
                </div>
                <div class="col-xl-3">
    ...
    <section class="vs-pricing-wrapper bg-auto bg-top vs-pricing-layout1 background-image space-top"
        data-vs-img="{{ asset('asset-about/img/about/Banner-Diskon-Menarik-Landing-About-1920-x-919.png') }}"
        id="price">
        <div class="container">
            <div class="row flex-row-reverse">
                    ...
                    <div class="price-list-style1 bg-white py-60 px-60">
                        <div class="vs-price-list media">
                            <div class="media-img mr-30">
                                <a href="{{ route('shop.index') }}"><img width="120" height="120"
                                        src="{{ asset('asset-about/img/product/600x750_CICA--B5-REFRESHING-TONER.jpg') }}"
                        ...
                        <div class="vs-price-list media">
                            <div class="media-img mr-30">
                                <a href="{{ route('shop.index') }}"><img width="120" height="120"
                                        src="{{ asset('asset-about/img/product/600x750_HONEY-CLEANSING-GEL.jpg') }}"
                                        alt="PE Skinpro Promo" /></a>
                            </div>
                            <div class="media-body align-self-center">
                                <h3 class="price-title h4 mb-10">
                        ...
                        <div class="vs-price-list media">
                            <div class="media-img mr-30">
                                <a href="{{ route('shop.index') }}"><img width="120" height="120"
                                        src="{{ asset('asset-about/img/product/600x750_HYDRO-RESTORATIVE-CREAM.jpg') }}"
                                        alt="PE Skinpro Promo" /></a>
                            </div>
                            <div class="media-body align-self-center">
                                <h3 class="price-title h4 mb-10">
                        ...
                        <div class="vs-price-list media">
                            <div class="media-img mr-30">
                                <a href="{{ route('shop.index') }}"><img width="120" height="120"
                                        src="{{ asset('asset-about/img/product/600x750_PREBIOTIC-PORE-EX.jpg') }}"
                                        alt="PE Skinpro Promo" /></a>
                            </div>
                            <div class="media-body align-self-center">
                                <h3 class="price-title h4 mb-10">
                        ...
                        <div class="text-center">
                            <div class="header-btn">
                                <a href="{{ route('shop.index') }}" class="vs-btn vs-styleCustom rounded text-lg">Belanja
                                    Sekarang</a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="vs-blog-wrapper vs-blog-layout1 link-inherit bg-light-theme space-top space-md-bottom" id="blog">
        <div class="container">
            ...
            <div class="row vs-carousel wow fadeInUp" data-wow-delay="0.3s"
                ...
                data-mdslidetoshow="{{ $articles->count() >= 2 ? 2 : $articles->count() }}" data-smslidetoshow="1"
                data-xsslidetoshow="1">
                @foreach ($articles as $item)
                    <div class="col-lg-4">
                        <div class="vs-blog">
                            <div class="blog-image image-scale-hover">
                                <a href="{{ route('about.newsDetail', $item->slug) }}"><img
                                        src="{{ asset('storage/' . $item->images) }}" alt="Blog Image"
                                        class="w-100" /></a>
                            </div>
