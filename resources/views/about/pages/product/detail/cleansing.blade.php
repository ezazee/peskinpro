                    ...
                    <div class="vs-gallery-content">
                                ...
                                <div class="col-md-6 mb-30 mb-md-0">
                                    <div class="hover-img-scale">
                                        <img class="img-detail-showcase"
                                            src="{{ asset('asset-about/img/phtproduct/gel.jpg') }}"
                                            alt="Honey Cleansing Gel" class="w-100" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="hover-img-scale">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="vs-list-style1">
                                    <blockquote class="instagram-media" data-instgrm-captioned
                                        data-instgrm-permalink="https://www.instagram.com/p/DFSbtyWxwGy/?utm_source=ig_embed&amp;utm_campaign=loading"
                                        data-instgrm-version="14"
                                        style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                                        <div style="padding:16px;"> <a
                                                href="https://www.instagram.com/p/DFSbtyWxwGy/?utm_source=ig_embed&amp;utm_campaign=loading"
                            ...
                            <div class="col-lg-6">
                                <div class="vs-list-style1">
                                    <blockquote class="instagram-media" data-instgrm-captioned
                                        data-instgrm-permalink="https://www.instagram.com/p/DFmSAOcxPsS/?utm_source=ig_embed&amp;utm_campaign=loading"
                                        data-instgrm-version="14"
                                        style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                                        <div style="padding:16px;"> <a
                                                href="https://www.instagram.com/p/DFmSAOcxPsS/?utm_source=ig_embed&amp;utm_campaign=loading"
                                                style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;"
                                                target="_blank">
                                                <div style=" display: flex; flex-direction: row; align-items: center;">
                                                    <div
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="vs-list-style1">
                                    <ol>
                                        <li>Basahi wajah. Oleskan sedikit gel dengan lembut pada wajah dan leher.</li>
                                        <li>Bilas secara menyeluruh dengan air.</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        <div class="pb-60 pt-60 border-top border-light-theme">
                            <div class="row">
                                <div class="col-md-6 mb-30 mb-md-0">
                                    <div class="hover-img-scale">
                                        <img class="img-detail-showcase"
                                            src="{{ asset('asset-about/img/proof/cleansing.png') }}"
                                            alt="Honey Cleansing Gel" class="w-100" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="hover-img-scale">
                                        <img class="img-detail-showcase"
                                            src="{{ asset('asset-about/img/proof/proofcleansing.png') }}"
                                            alt="Honey Cleansing Gel" class="w-100" />
                                    </div>
                                </div>
                            </div>
