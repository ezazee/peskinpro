                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div
                                                        ...
                                                        @if ($prod->front_image)
                                                            <img src="{{ asset('storage/' . $prod->front_image) }}"
                                                                alt="" class="avatar-md">
                                                        @else
                                                            <span>No Image</span>
                                                        @endif
                                                    ...
                                                    <div>
                                                        <a href="#!"
                                                            class="text-dark fw-medium fs-15">{{ $prod->name }}</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="mb-1 text-muted"><span class="text-dark fw-medium">Rp
                                                    {{ number_format($prod->sizes[0]->price - $prod->sizes[0]->discount, 0, ',', '.') }}
                                            </td>
                                            <td>
                                                <p class="mb-1 text-muted"><span
                                                        class="text-dark fw-medium">{{ $prod->sizes[0]->stock }}</span></p>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a href="{{ route('product.edit', $prod->slug) }}"
                                                    ...
                                                    <form action="{{ route('product.destroy', $prod->id) }}" method="POST"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="btn btn btn-danger btn-sm"><iconify-icon
