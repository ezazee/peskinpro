...
@section('content')
    <section class="banner bg-gradient-primary position-relative overflow-hidden">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="block text-center text-lg-start pe-0 pe-xl-5">
                        <h1 class="text-white text-capitalize mb-4">Dapatkan Komisi dengan PE Skinpro Affiliate!</h1>
                        <p class="mb-4 text-white">Dapatkan keuntungan hingga jutaan hanya dengan jari mu saja! klik, share,
                            cuan!
                        </p> <a class="btn btn-primary" href="{{ route('about.RaihKomisi') }}">Cara Raih Komisi Affiliate<span
    ...
    <section class="section testimonials overflow-hidden bg-tertiary">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        <h1 class="mb-4">Buat Komisimu <br> Sekarang Juga!</h1>
                    </div>
                </div>
            </div>
            <div class="row position-relative">
                <div class="col-lg-4 col-md-6 pt-1">
                    <div class="shadow rounded bg-white p-4 mt-4">
                        <div class="d-block d-sm-flex align-items-center mb-3">
                            <img loading="lazy" class="rounded" decoding="async"
                                src="{{ asset('asset-affiliate/images/testi/testi1.png') }}" alt="Dimas PE Skinpro"
                                class="img-fluid" width="65" height="66">
                            <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
                                <h4 class="h5 mb-1">Dimas Aditya Nugroho</h4>
                ...
                <div class="col-lg-4 col-md-6 pt-1">
                    <div class="shadow rounded bg-white p-4 mt-4">
                        <div class="d-block d-sm-flex align-items-center mb-3">
                            <img loading="lazy" class="rounded" decoding="async"
                                src="{{ asset('asset-affiliate/images/testi/testi2.png') }}" alt="Dimas PE Skinpro"
                                class="img-fluid" width="65" height="66">
                            <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
                                <h4 class="h5 mb-1">M. Reza Reziyanto</h4>
                ...
                <div class="col-lg-4 col-md-6 pt-1">
                    <div class="shadow rounded bg-white p-4 mt-4">
                        <div class="d-block d-sm-flex align-items-center mb-3">
                            <img loading="lazy" class="rounded" decoding="async"
                                src="{{ asset('asset-affiliate/images/testi/testi3.jpg') }}" alt="Dimas PE Skinpro"
                                class="img-fluid" width="65" height="66">
                            <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
                                <h4 class="h5 mb-1">Risqy Adriana</h4>
