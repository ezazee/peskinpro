<head>
    ...
    @if (Route::currentRouteName() === 'articlebyTittle')
        <title>{{ $meta_title ?? 'PEskinpro Indonesia Official' }}</title>
        <meta name="description" content="{{ $meta_description ?? 'Default description for PEskinpro Indonesia.' }}">
        <meta name="keywords" content="{{ $meta_keywords ?? 'default, peskin, pro, indonesia' }}">
        <meta name="author" content="PEskinpro Indonesia">

        <meta property="og:title" content="{{ $meta_title ?? 'PEskinpro Indonesia Official' }}">
        <meta property="og:description" content="{{ $meta_description ?? 'Default description for PEskinpro Indonesia.' }}">
        ...
        <meta name="twitter:title" content="{{ $meta_title ?? 'PEskinpro Indonesia Official' }}">
        <meta name="twitter:description" content="{{ $meta_description ?? 'Default description for PEskinpro Indonesia.' }}">
    ...
    @elseif (Route::currentRouteName() === 'shop.detail')
        <title>{{ $meta_title ?? 'PEskinpro Indonesia Official' }}</title>
        <meta name="description" content="{{ $meta_description ?? 'Explore the best products on PEskinpro Indonesia.' }}">
    ...
    @else
        <title>PEskinpro Indonesia Official</title>
        <meta name="description" content="Welcome to PEskinpro Indonesia Official website. Your Trusted Skin Partner">
        <meta name="keywords" content="PESkin, PES, Pro Evolution Soccer, skins, Indonesia">
        <meta name="author" content="PEskinpro Indonesia">

        <meta property="og:title" content="PEskinpro Indonesia Official">
        ...
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="PEskinpro Indonesia Official">
