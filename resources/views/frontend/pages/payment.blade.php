                                        ...
                                        <div class="row">
                                            <div class="col-12 mt-3 relative">
                                                <input class="cursor-pointer border-line px-4 py-3 w-full rounded mt-2 "
                                                    type="text" id="cardNumberCredit" placeholder="ex.1234567290"
                                        ...
                                        <div class="upload_image col-span-full">
                                            <div class="flex flex-wrap flex-col gap-5">
                                                <div>
                                                    ...
                                                    <div class="upload_file flex items-center gap-3 w-full mt-3 px-3 py-2 border border-line rounded">
                                                        <label for="uploadImage" class="caption2 py-1 px-3 rounded bg-line whitespace-nowrap cursor-pointer">Choose File</label>
                                                        <input type="file" name="images" class="caption2 cursor-pointer w-full" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="bg_img flex-shrink-0 relative w-full rounded-lg overflow-hidden bg-surface mt-5">
                                                    ...
                                                    <img src="https://i.pinimg.com/736x/68/ed/dc/68eddcea02ceb29abde1b1c752fa29eb.jpg"
