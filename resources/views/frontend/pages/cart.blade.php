                                ...
                                @foreach ($cartCollection as $item)
                                    <div class="item flex md:mt-7 md:pb-7 mt-5 pb-5 border-b border-line w-full">
                                        <div class="w-1/2 flex items-center">
                                            <input type="checkbox" id="product-checkbox-{{ $item->id }}"
                                                class="product-checkbox mr-2 cursor-pointer" data-id="{{ $item->id }}"
                                            ...
                                            <label for="product-checkbox-{{ $item->id }}"
                                                class="flex items-center px-5 gap-6 w-full">
                                                <div class="bg-img md:w-[100px] w-20 aspect-[3/4]">
                                                    <img src="{{ asset('storage/' . $item->product->front_image) }}"
                                                        alt="img" class="w-full h-full object-cover rounded-lg">
                                                </div>
                                                <div>
                                            ...
                                            <div class="text-title text-center">
                                                ...
                                                @if ($item->productSize->discount && $item->productSize->discount > 0)
                                                    <div class="font-normal text-secondary2 text-sm">
                                                        <del>Rp
                                                            {{ number_format($item->productSize->price, 0, ',', '.') }}</del>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
