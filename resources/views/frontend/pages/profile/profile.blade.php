                    ...
                    <form action="{{ route('usersprofiles', $user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid sm:grid-cols-2 gap-4 gap-y-5 mt-5">
                            <div class="first-name">
                                ...
                                <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="firstName" type="text"
                            ...
                            <div class="last-name">
                                <label for="lastName" class="caption1 capitalize">Nama Belakang <span
                                        class="text-red">*</span></label>
                                <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="lastName" type="text"
                            ...
                            <div class="phone-number">
                                ...
                                <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="phoneNumber" type="text"
                                    name="no_telp" value="{{ $user->no_telp }}" placeholder="Masukan No Whatsapp" />
                            </div>
                            <div class="email">
