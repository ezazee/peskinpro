                            ...
                            <div class="upload_image col-span-full">
                                ...
                                <div class="flex flex-wrap items-center gap-5 mt-3">
                                    <div
                                        ...
                                        @if($user->images)
                                        <img src="{{ asset('storage/' . $user->images) }}" alt="User Image" class="upload_img relative z-[1] w-full h-full object-cover">
                                        @else
                            ...
                            <div class="grid sm:grid-cols-2 gap-4 gap-y-5 mt-5">
                                <div class="first-name">
                                    ...
                                    <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="firstName"
                                        type="text" name="first_name" value="{{ $user->first_name }}" placeholder="Masukan Nama Depan"
                                     />
                                </div>
                                <div class="last-name">
                                    ...
                                    <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="lastName"
                                        type="text" name="last_name" value="{{ $user->last_name }}" placeholder="Masukan Nama Belakang"
                                     />
                                </div>
                                <div class="phone-number">
                                    ...
                                    <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="phoneNumber"
                                        type="text" name="no_telp" value="{{ $user->no_telp }}" placeholder="Masukan No Whatsapp"
                                     />
                                </div>
                                <div class="email">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                ...
                                <div class="confirm-pass">
                                    ...
                                    <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="confirmPassword"
                                        type="password" name="password_confirmation" placeholder="Masukan Konfirmasi Password *" />
                                </div>
                            </div>
