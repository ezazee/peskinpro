                ...
                <div class="right list-filter md:w-2/3 w-full pl-2.5">
                    <div class="filter-item text-content w-full active">
                        ...
                        <div class="flex flex-col md:flex-row md:justify-between mt-5">
                            <span><span style="color:red;">*</span> Isi Data untuk pencairan</span>
                            <span class="mt-3"><span style="color:red;">*</span><strong> Min Rp.150.000 (Seratus Limapuluh Ribu Rupiah)</strong></span>
                        </div>
                    ...
                    <div class="filter-item text-content w-full p-7 mt-5 border border-line rounded-xl active">
                        <form action="{{ route('affiliate.Withdraw') }}" method="POST">
                            ...
                            <div class="first-name">
                                ...
                                <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" type="number" name="nominal"
                                    placeholder="Nominal" />
                            </div>
                            ...
                            <div class="email">
                                ...
                                <input class="border-line mt-2 px-4 py-3 bg-gray w-full rounded-lg" type="password"
