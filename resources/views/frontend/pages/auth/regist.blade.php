                ...
                <div class="left md:w-1/2 w-full lg:pr-[60px] md:pr-[40px] md:border-r border-line">
                    ...
                    <form class="md:mt-7 mt-4" action="{{ route('register') }}" method="POST">
                        ...
                        <div class="pass mt-5 relative">
                            <input class="border-line px-4 pt-3 pb-3 w-full rounded-lg" id="register-password"
                                type="password" placeholder="Password" name="password" required />
                            <button id="toggleRegisterPassword" type="button"
                        ...
                        <div class="confirm-pass mt-5 relative">
                            <input class="border-line px-4 pt-3 pb-3 w-full rounded-lg" id="confirm-password"
                                type="password" placeholder="Masukan Ulang Password *" name="password_confirmation"
                                required />
