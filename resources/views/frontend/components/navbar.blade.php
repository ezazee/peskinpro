    ...
    <div class="container mx-auto h-full">
        <div class="header-main flex justify-between h-full">
            ...
            <a href="/" class="flex items-center">
                <img src="{{ asset('frontend/assets/images/logo/peskin.png') }}" alt="PeskinPro" width="60px" height="60px">
            </a>
                ...
                <ul class="flex items-center gap-8 h-full">
                    <li class="h-full relative">
                        ...
                        <div class="sub-menu py-3 px-5 -left-10 w-max absolute grid grid-cols-4 gap-5 bg-white rounded-b-xl">
                            <ul>
                                <li>
                                    <a href="index-2.html" class="link text-secondary duration-300"> Home Fashion 1 </a>
                                </li>
                                <li>
                                    <a href="fashion2.html" class="link text-secondary duration-300"> Home Fashion 2 </a>
                                </li>
                                <li>
                                    <a href="fashion3.html" class="link text-secondary duration-300"> Home Fashion 3 </a>
                                </li>
                                <li>
                                    <a href="fashion4.html" class="link text-secondary duration-300"> Home Fashion 4 </a>
                                </li>
                                <li>
                                    <a href="fashion5.html" class="link text-secondary duration-300"> Home Fashion 5 </a>
                                </li>
                                <li>
                                    <a href="fashion6.html" class="link text-secondary duration-300"> Home Fashion 6 </a>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <a href="fashion7.html" class="link text-secondary duration-300"> Home Fashion 7 </a>
                                </li>
                                <li>
                                    <a href="fashion8.html" class="link text-secondary duration-300"> Home Fashion 8 </a>
                                </li>
                                <li>
                                    <a href="fashion9.html" class="link text-secondary duration-300"> Home Fashion 9 </a>
                                </li>
                                <li>
                                    <a href="fashion10.html" class="link text-secondary duration-300"> Home Fashion 10 </a>
                                </li>
                                <li>
                                    <a href="fashion11.html" class="link text-secondary duration-300"> Home Fashion 11 </a>
                                </li>
                                <li>
                                    <a href="underwear.html" class="link text-secondary duration-300"> Home Underwear </a>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <a href="cosmetic1.html" class="link text-secondary duration-300"> Home Cosmetic 1 </a>
                                </li>
                                <li>
                                    <a href="cosmetic2.html" class="link text-secondary duration-300"> Home Cosmetic 2 </a>
                                </li>
                                <li>
                                    <a href="cosmetic3.html" class="link text-secondary duration-300 active"> Home Cosmetic 3 </a>
                                </li>
                                <li>
                                    <a href="pet.html" class="link text-secondary duration-300"> Home Pet Store </a>
                                </li>
                                <li>
                                    <a href="jewelry.html" class="link text-secondary duration-300"> Home Jewelry </a>
                                </li>
                                <li>
                                    <a href="furniture.html" class="link text-secondary duration-300"> Home Furniture </a>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <a href="watch.html" class="link text-secondary duration-300"> Home Watch </a>
                                </li>
                                <li>
                                    <a href="toys.html" class="link text-secondary duration-300"> Home Toys Kid </a>
                                </li>
                                <li>
                                    <a href="yoga.html" class="link text-secondary duration-300"> Home Yoga </a>
                                </li>
                                <li>
                                    <a href="organic.html" class="link text-secondary duration-300"> Home Organic </a>
                                </li>
                                <li>
                                    <a href="marketplace.html" class="link text-secondary duration-300"> Home Marketplace </a>
                                </li>
                            </ul>
                        </div>
                    </li>
                            ...
                            <div class="container">
                                <div class="flex justify-between py-8">
                                    <div class="nav-link basis-2/3 grid grid-cols-4 gap-y-8">
                                        <div class="nav-item">
                                            <div class="text-button-uppercase pb-2">Sale & Offer</div>
                                            <ul>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Starting From 50% Off </a>
                                                </li>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Faces Skin </a>
                                                </li>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Eyes Makeup </a>
                                                </li>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Lip Polish </a>
                                                </li>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer view-all-btn"> View All </a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="nav-item">
                                            <div class="text-button-uppercase pb-2">Makeup</div>
                                            <ul>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Hair Treatment </a>
                                                </li>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Nail Polish </a>
                                                </li>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Liquid Lipstick </a>
                                                </li>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Face Highlighter </a>
                                                </li>
                                                <li>
                                        ...
                                        <div class="nav-item">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Eye Palettes </a>
                                                </li>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Nail Custom </a>
                                                </li>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Lip Oil </a>
                                                </li>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Hair Serums </a>
                                                </li>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 view-all-btn"> View All </a>
                                                </li>
                                        ...
                                        <div class="nav-item">
                                            <div class="text-button-uppercase pb-2">New product</div>
                                            <ul>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Faces Skin </a>
                                                </li>
                                    ...
                                    <div class="banner-ads-block pl-2.5 basis-1/3">
                                        <a href="shop-breadcrumb1.html" class="banner-ads-item bg-linear rounded-2xl relative block overflow-hidden cursor-pointer">
                                            <div class="text-content py-14 pl-8 relative z-[1]">
                                                ...
                                                <div class="heading6 mt-2">Dive into Savings <br />on Cosmetic</div>
                                                <div class="body1 mt-3 text-secondary">Starting at <span class="text-red">$59.99</span></div>
                                                <div class="button-main mt-5">Shop Now</div>
                                            </div>
                                            <img src="assets/images/other/bg-feature-cosmetic.png" alt="bg-img" class="absolute left-0 top-0 w-full h-full object-cover" />
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="flex justify-between py-8">
                                    ...
                                    <div class="recent-product pl-2.5 basis-1/3">
                                        ...
                                        <div class="list-product hide-product-sold grid grid-cols-2 gap-5 mt-3">
                                            <div class="product-item grid-type" data-item="49">
                                                <div class="product-main cursor-pointer block">
                                                    <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                                        <div class="product-tag text-button-uppercase bg-red text-white px-3 py-0.5 inline-block rounded-full absolute top-3 left-3 z-[1]">Sale</div>
                                                        ...
                                                        <div class="product-img w-full h-full aspect-[3/4]">
                                                            <img class="w-full h-full object-cover duration-700" src="assets/images/product/cosmetic/4-1.png" alt="img" />
                                                            <img class="w-full h-full object-cover duration-700" src="assets/images/product/cosmetic/4-2.png" alt="img" />
                                                        </div>
                                            ...
                                            <div class="product-item grid-type" data-item="53">
                                                <div class="product-main cursor-pointer block">
                                                    <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                            ...
                            <div class="sub-nav-mobile">
                                ...
                                <div class="list-nav-item w-full grid grid-cols-2 pt-2 pb-6">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="fashion4.html" class="nav-item-mobile link text-secondary"> Home Fashion 4 </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="cosmetic3.html" class="nav-item-mobile link text-secondary duration-300 active"> Home Cosmetic 3 </a>
                                        </li>
                                        <li>
                            ...
                            <div class="sub-nav-mobile">
                                ...
                                <div class="list-nav-item w-full pt-2 pb-6">
                                    <div class="nav-link grid grid-cols-2 gap-5 gap-y-6">
                                        ...
                                        <div class="nav-item">
                                            <div class="text-button-uppercase pb-1">Makeup</div>
                                            <ul>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Hair Treatment </a>
                                                </li>
                                        ...
                                        <div class="nav-item">
                                            <div class="text-button-uppercase pb-1">New product</div>
                                            <ul>
                                                <li>
                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Faces Skin </a>
                                                </li>
