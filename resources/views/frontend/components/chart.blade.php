<div class="modal-cart-block" style="z-index: 1001">
    <div class="modal-cart-main flex">
        <div class="left w-1/2 border-r border-line py-6 max-md:hidden">
            <div class="heading5 px-6 pb-3">Kamu Mngkin suka:</div>
            <div class="list px-6">
            ...
            <div class="footer-modal bg-white absolute bottom-0 left-0 w-full">
                ...
                <div class="tab-item note-block">
                    ...
                    <div class="form pt-4 px-6">
                        <textarea name="form-note" id="form-note" rows="4" placeholder="Add special instructions for your order..."
