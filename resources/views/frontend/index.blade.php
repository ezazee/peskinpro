...
<div class="shop-product py-10">
    <div class="container">
        <div class="heading3 text-center py-10">Produk Face Care</div>
        <div class="list-product hide-product-sold grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 sm:gap-[30px] gap-5">
            ...
            <div class="product-item grid-type style-5">
                @php
                $totalStock = $item->sizes->pluck('stock')->sum();
                @endphp
                    @if ($totalStock > 0)
                        <a href="{{ route('shop.detail', ['slug' => $item->slug]) }}">
                    @endif
                    ...
                    <div class="product-main cursor-pointer block">
                        <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                            @if ($item->sizes->pluck('discount')->filter(function ($discount) { return $discount > 0;
                            })->isNotEmpty())
                        ...
                        <div class="product-infor mt-4 lg:mb-7">
                            ...
                            @if ($totalStock <= 0) <div class="text-red-500 font-bold text-sm mt-2">Stok Habis</div>@endif
                    </div>
            </div>
                @if ($totalStock > 0)
                </a>
...
<div class="container mt-5">
    <div class="benefit-block md:py-20 py-10">
        <div class="list-benefit grid items-start md:grid-cols-5 grid-cols-2 gap-[30px]">
            ...
            <div class="benefit-item flex flex-col items-center justify-center">
                <img src="{{ asset('frontend/assets/images/cert/lab-tested.png') }}" alt="Lab Tested" class="w-1/3">
                <div class="body1 font-semibold uppercase text-center mt-5">Lab Tested</div>

            </div>
            <div class="benefit-item flex flex-col items-center justify-center">
                <img src="{{ asset('frontend/assets/images/cert/cruelty-cert.png') }}" alt="Cruelty" class="w-1/3">
